...
/*                Kollege updatedKollege = dataSource.updateKollege(kollege.getId(), kollege.getVorname(), kollege.getNachname(), kollege.getPasswort(), kollege.getKuerzel(), kollege.getStatus());
