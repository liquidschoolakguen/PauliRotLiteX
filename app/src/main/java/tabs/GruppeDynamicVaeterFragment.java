...
public class GruppeDynamicVaeterFragment extends Fragment implements GruppeViewAdapter.ItemClickListener {
    ...
    public GruppeDynamicVaeterFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if ((sectionNumber)==2) {
            ...
            Log.d("GruppeTest", "sectionNumber aus Väter "+sectionNumber);
...
//Brüder
    ...
    public static GruppeDynamicVaeterFragment newInstance(int sectionNumber) {
        GruppeDynamicVaeterFragment fragment = new GruppeDynamicVaeterFragment();
