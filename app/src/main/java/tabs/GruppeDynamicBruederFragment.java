...
public class GruppeDynamicBruederFragment extends Fragment implements GruppeViewAdapter.ItemClickListener {
    ...
    public GruppeDynamicBruederFragment() {
...
//Brüder
    ...
    public static GruppeDynamicBruederFragment newInstance(int sectionNumber) {
        GruppeDynamicBruederFragment fragment = new GruppeDynamicBruederFragment();
