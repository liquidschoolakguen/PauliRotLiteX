...
/*                Lerngruppe updatedLerngruppe = dataSource.updateLerngruppe(lerngruppe.getId(), lerngruppe.getVorname(), lerngruppe.getItemType(), lerngruppe.getPersonaltyp(), lerngruppe.getGeburtstag(), lerngruppe.getStrasse());
